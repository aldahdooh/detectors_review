...
class sfad_a:
    def __init__(self, mode='train', no_defense_h5="tiny_model_1.h5", filename="multi_tiny_model_v7.h5", coverage=0.95, coverage_th=0.5, alpha=0.5 , normalize_mean=False):
        self.mode = mode
